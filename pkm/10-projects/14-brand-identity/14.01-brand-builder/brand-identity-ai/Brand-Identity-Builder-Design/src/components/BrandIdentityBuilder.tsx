...
const STEPS = [
  { id: 0, name: 'Brand Seed Discovery', description: 'Discover your brand triggers' },
  { id: 1, name: 'Brand Identity System', description: 'Define mission, vision & values' },
  { id: 2, name: 'Brand Naming', description: 'Create your brand name' },
  { id: 3, name: 'Brand Language Design', description: 'Develop voice & messaging' },
  { id: 4, name: 'Concept Validation', description: 'Validate your brand concept' },
  { id: 5, name: 'Execution Design', description: 'Plan implementation strategy' },
  { id: 6, name: 'Branding Wheel Completion', description: 'Complete your brand essence' }
];
...
export function BrandIdentityBuilder() {
  ...
  const [projectName, setProjectName] = useState('New Brand Project');
  ...
  const handleNewProject = () => {
    ...
    setQAHistory([]);
    setBrandData({});
    setProjectName('New Brand Project');
      ...
      <div className="min-h-screen bg-background">
        <header className="border-b border-border p-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Brand Identity Builder</h1>
              <p className="text-muted-foreground">{projectName} - Completed!</p>
            </div>
