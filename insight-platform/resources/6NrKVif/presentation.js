document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        if (slides.length > 0) {
            ...
            const initialElements = getAnimatedElements(slides[0]);
            if (initialElements.length > 0 && typeof gsap !== 'undefined') {
                gsap.fromTo(initialElements, { opacity: 0, y: 20 }, { opacity: 1, y: 0, stagger: 0.1, duration: 0.8, ease: 'power3.out' });
            }
        } else {
